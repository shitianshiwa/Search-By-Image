...
function init() {
    ...
    setTimeout(() => { //延时进行动作，才有效
        ...
        try {
            ...
            temp1.setAttribute('class', 'soutucss2');
            ...
            for (let i = 0; i < s2.length; i++) {
                ...
                temp2[i].setAttribute('class', 'soutucss');
            ...
            temp2[0].addEventListener('click', () => {
                    ...
                    temp2[1].addEventListener('mousedown', event => {
                        action(event);
                    });
...
function action(event) {
    //console.log(event.path[0].getAttribute("id"));
    ...
    if (event[setting.hot_key] == true && event.button == 2 || event.path[0].getAttribute("id") == "soutux") {
